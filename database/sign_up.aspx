<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="sign_up.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <tr>
                ...
                <td style="text-align: center">
                    <b><h2>&nbsp;</h2>
                    <asp:Label ID="Label8" runat="server" Text="For Librarian Registration" 
                        BorderStyle="None" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
                    </b>
                    <br />
                    <br />
                    <asp:Button ID="Button3" runat="server" BorderColor="Black" Font-Bold="True" 
                        Font-Size="Large" Height="33px" onclick="Button3_Click" Text="Click" 
                        Width="85px" BackColor="#999999" BorderWidth="2px" />
                    <br />
